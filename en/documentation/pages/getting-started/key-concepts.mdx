...
Build workflow apps to handle single-turn tasks. The webapp interface and API provides easy access to batch execute many tasks at once. Workflows are ideal for batch processing, data transformations, and automated tasks that don't require conversation context.
