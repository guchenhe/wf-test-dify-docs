...
Now that you've built your first workflow, explore these resources to enhance your skills:

- Learn about [version control](/documentation/pages/build/version-control) to track and manage workflow iterations
- Discover more [powerful nodes](/documentation/pages/nodes/llm) to expand your workflow capabilities
- Explore [debugging tools](/documentation/pages/debug/step-run) to troubleshoot and optimize your workflows
