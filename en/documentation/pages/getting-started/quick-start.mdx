...
<Note>
  You can also share your workflow with others by clicking the **Share** button. This generates a unique URL that allows others to view or use your workflow without needing access to your Dify workspace.
</Note>
