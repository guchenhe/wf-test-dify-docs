---
title: "End Node"
description: "Configure workflow outputs and properly terminate workflow execution"
icon: "flag-checkered"
---

The End node defines what your workflow outputs when it completes. Every workflow application needs at least one End node to return results to users and terminate execution. The End node packages all your workflow's output data into a structured response.
