---
title: "Start Node"
description: "Configure workflow entry points and define input variables for your applications"
icon: "play"
---

The Start node is the entry point of every workflow and chatflow application. It defines what inputs your application accepts from end users and provides system variables that you can reference throughout your workflow. Think of it as the gateway that channels user data into your workflow logic.
