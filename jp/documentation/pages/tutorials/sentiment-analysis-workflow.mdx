...
### ニュートラルレスポンステンプレート
```markdown
ℹ️ **ニュートラルな感情** ({{confidence}}% の信頼度)

あなたのテキストはバランスが取れているか、中立的に見えます。
...
- [変数集約器](/en/documentation/pages/nodes/variable-aggregator)

<Tip>
  感情分析結果をナレッジベースに保存して、将来の参照とモデルの微調整に活用しましょう。
</Tip>